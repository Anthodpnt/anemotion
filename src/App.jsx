...
const App = () => {
  ...
  const smallWidth = useMedia('(max-width: 1279px)')
  const smallHeight = useMedia('(max-height: 719px)')
  ...
  if (smallWidth || smallHeight) {
    return (
      <Message icon={<Help width={48} />} title="Coming soon" text="This website looks better on a larger resolution." />
    )
  }
